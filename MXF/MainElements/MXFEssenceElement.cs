    ...
    public class MXFEssenceElement : MXFKLV
    {
        ...
        public long EssenceOffset
        {
            get
            {
                ...
                if (this.Partition.FirstDataEssenceElement != null)
                    return (this.Offset - this.Partition.FirstDataEssenceElement.Offset) + ((long)this.Partition.BodyOffset);
            ...
            : base(headerKLV, "EssenceElement", KeyType.Essence)
        {
            ...
            this.IsData = (this.Key[12] == 0x07 || this.Key[12] == 0x17 || this.Key[12] == 0x01);
